...
NODES=(
    ...
    "https://github.com/cksdnfas/ComfyUI-Remote-Executor"
)
...
"https://huggingface.co/xxxpo13/SkinRealism/resolve/main/skin_4-000015.safetensors"
"https://huggingface.co/kadirnar/flux_lora/resolve/main/filmstyle.safetensors"
)
